...
public class SQLQueries {
    ...
    public static final String SQL_GET_ACTIVE_SESSION_COUNT_BY_TENANT =
            "SELECT COUNT(IDN_AUTH_SESSION_META_DATA.SESSION_ID) " +
            ...
            "INNER JOIN IDN_AUTH_USER ON IDN_AUTH_USER_SESSION_MAPPING.USER_ID = IDN_AUTH_USER.USER_ID " +
            "WHERE IDN_AUTH_SESSION_META_DATA.PROPERTY_TYPE = ? AND IDN_AUTH_SESSION_META_DATA.VALUE " +
            "BETWEEN ? AND ? AND IDN_AUTH_USER.TENANT_ID = ? GROUP BY IDN_AUTH_USER.TENANT_ID";
